            ...
            <div class="row y-gap-50 justify-between items-center">
              <div class="col-lg-6 pr-50 sm:pr-15">
                <div class="composition -type-8">
                  <div class="-el-1"><img src="img/general/pak nurdin.png" alt="image"></div>
                </div>
              </div>

              <div class="col-lg-5">
                <h2 class="text-30 lh-16">Assalamualikum wr. wb</h2>
...
<!-- Mirrored from creativelayers.net/themes/educrat-html/about-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jul 2022 12:44:45 GMT -->
</html>