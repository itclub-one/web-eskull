            ...
            <div class="row y-gap-50 justify-between items-center">
              <div class="col-lg-6 pr-50 sm:pr-15">
                <div class="composition -type-8">
                  <div class="-el-1"><img style="width: 400px; height: 400px;" src="img/logo/itc.png" alt="image"></div>
                </div>
              </div>
          ...
          <div data-anim-wrap class="container">
            ...
            <div class="row y-gap-30 pt-50">
              ...
              <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-2" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image">
                    <img style="width: 300px; height: 350px;" src="img/general/naufall.jpg" alt="image">
                  ...
                  <div class="teamCard__content">
                    <h4 class="teamCard__title">Naufal Rabani</h4>
                    <p class="teamCard__text">Atasan Progja WEB Bangsat, tapi selalu tersenyum</p>
              ...
              <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-2" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image">
                    <img style="width: 300px; height: 350px;" src="img/general/ilham.jpg" alt="image">
                    <div class="teamCard__socials">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
                  ...
                  <div class="teamCard__content">
                    <h4 class="teamCard__title">Yofi Ilham Fauzi</h4>
                    <p class="teamCard__text">Dewa Frontend Ni Bousss</p>
              ...
              <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-2" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image">
                    <img style="width: 300px; height: 350px;" src="img/general/aaa.jpg" alt="image">
                    <div class="teamCard__socials">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
                  ...
                  <div class="teamCard__content">
                    <h4 class="teamCard__title">Yusuf Sekhan Althaf</h4>
                    <p class="teamCard__text">Susuga Dewa Beken Ululululu</p>
              ...
              <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-2" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image">
                    <img style="width: 300px; height: 350px;" src="img/general/aaaa.jpg" alt="image">
                    <div class="teamCard__socials">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
                  ...
                  <div class="teamCard__content">
                    <h4 class="teamCard__title">Muhammad Ikhsan Nawawi</h4>
                    <p class="teamCard__text">Ikut Join aja tapi Penggendong handalS</p>
...
<!-- Mirrored from creativelayers.net/themes/educrat-html/about-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jul 2022 12:44:45 GMT -->
</html>