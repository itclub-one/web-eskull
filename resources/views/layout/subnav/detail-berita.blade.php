                  ...
                  <div data-anim-child="slide-up delay-4" class="col-lg-12 col-md-6">
                    <a  class="blogCard -type-1 texttt">
                      ...
                      <div class="blogCard__content mt-20">
                        <h4 class="blogCard__title text-20 lh-15 fw-500 mt-5">{{$detail->judul_berita}}</h4>
                        <div class="blogCard__date text-14 mt-5">{{\Carbon\Carbon::parse($detail->tanggal_berita)->format('F d, Y')}}</div>
                      </div>
                    </a>
                  </div>
