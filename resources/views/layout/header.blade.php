                            ...
                            <div class="header-menu__content">
                                    ...
                                    <ul class="menu__nav text-dark-1 -is-active">
                                        ...
                                        <li class="menu-item-has-children dropdown">
                                            ...
                                            <ul class="subnav dropdown-menu martoppp">
                                                ...
                                                <li><a class=" dropdown-item" href="kepala-sekolah">Sambutan Kepala
                                                        Sekolah</a>
                                                </li>

                                                <li><a class=" dropdown-item" href="wakil-kepala-sekolah">Sambutan
                                                        Wakasek Bidang
                                                        Kesiswaan</a></li>

                                                <li><a class=" dropdown-item" href="visi-misi-sejarah">Sejarah, Visi,
                                                        dan Misi</a></li>

                                                <li><a class=" dropdown-item" href="tentang-web-ini">Tentang Web Ini</a>
                                                </li>
                                ...
                                <div class="mobile-footer px-20 py-20 border-top-light js-mobile-footer">
                                    ...
                                    <div class="lh-2 mt-10">
                                        <div>JALAN CIMANUK NO 309 A,<br> Kecamatan Tarogong Kidul <br> Kabupaten Garut
                    ...
                    <div class="col-auto">
                        <div class="footer-header-socials">
                            ...
                            <div class="footer-header-socials__list">
                                ...
                                <a class="" href="https://www.instagram.com/smkn1garut_official/"><i
                                        class="text-14 fa fa-instagram"></i></a>
