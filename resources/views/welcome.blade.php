        ...
        <div class="content-wrapper  js-content-wrapper">
                        ...
                        <div class="col-xl-7 col-lg-11 relative z-5">
                            <div class="masthead__content pl-32 lg:pl-0">
                                <h1 data-anim-child="slide-up delay-1" class="masthead__title">
                                    Temukan <span class="text-purple-1">Ekstrakulikuler</span> <br>yang ada di <br> SMKN
                                    1 Garut
                                </h1>
                                ...
                                <div class="masthead-image__el2">
                                    <div data-move="40"
                                        ...
                                        <div class="img-el__side">
                                            <div
                                                class="size-50 d-flex justify-center items-center bg-dark-1 rounded-full">
                    ...
                    <div class="row y-gap-30 justify-between sm:justify-start items-center pt-60 md:pt-50">
                        ...
                        <div class="col-lg-auto col-md-2 col-sm-3 col-4">
                            <div class="justify-center items-center px-4">
                                <img class="w-1/1" src="{{asset('webex/img/logo_pengembang/itc.png')}}"
                                     alt="logo image">
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-2 col-sm-3 col-4">
                            <div class="justify-center items-center px-4">
                                <img class="w-1/1" src="{{asset('webex/img/logo_pengembang/osis.png')}}"
                                     alt="clients image">
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-2 col-sm-3 col-4">
                            <div class="justify-center items-center px-4">
                                <img class="w-1/1" src="{{asset('webex/img/logo_pengembang/bc.png')}}"
                                     alt="clients image">
                            </div>
                        </div>
                    ...
                    <div class="row y-gap-20 justify-center text-center">
                        <div class="col-auto">
                            ...
                            <div class="sectionTitle ">
                                ...
                                <p class="sectionTitle__text ">Terdiri dari {{ $data->count() }} Ekstrakulikuler yang
                                    ada di SMKN 1 Garut!</p>
                                            ...
                                            <div data-anim-child="slide-left delay-2" class="infoCard -type-1">
                                                <div class="infoCard__image">
                                                    <img style="width: 100px; height: 99px;"
                                                         src="{{asset('logoeskul/'.$row->logo)}}" alt="{{$row->logo}}">
                                                </div>
            ...
            <section class="layout-pt-lg layout-pb-lg section-bg">
                ...
                <div data-anim-wrap class="container">
                    ...
                    <div class="relative">
                        <div class="overflow-hidden pt-60 lg:pt-50 js-section-slider" data-gap="30" data-loop
                                               ...
                                               class=" coursesCard -type-1 px-10 py-10 border-light bg-white rounded-8">
                                                <div class="relative">
                                                    <div class="coursesCard__image overflow-hidden rounded-8">
                                                        <img class="w-1/1"
                                                             src="{{asset('fotokegiatan/'.$row->foto_kegiatan)}}"
                                                ...
                                                <div class="h-100 px-10 pt-10">
                                                    ...
                                                    <div
                                                        class="text-17 lh-15 fw-500 text-dark-1 mt-10">{{$row->nama_kegiatan}}</div>
                                                    ...
                                                    <div class="coursesCard-footer">
                                                        <div class="coursesCard-footer__author">
                                                            <img src="{{asset('logodokumentasi/'.$row->logo)}}"
                                                                 alt="{{$row->logo}}">
                                                            <div>Admin</div>
                                                        </div>
                                                    </div>
