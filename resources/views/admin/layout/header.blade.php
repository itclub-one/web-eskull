...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__wobble" src="{{asset('logoeskul/smea.png')}}" alt="AdminLTELogo" height="180"
             width="180">
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{url("/")}}" class="brand-link">
            <img src="{{asset('logoeskul/smea.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{asset('fotousers/'.Auth::user()->foto)}}" class="img-circle elevation-2"
                         alt="{{Auth::user()->foto}}">
                </div>
                <div class="info">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{url('/administrator/dokumentasi')}}"
                           class="nav-link {{request()->is('dokumentasi') ? 'active' : ''}}">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Dokumentasi
                            </p>
