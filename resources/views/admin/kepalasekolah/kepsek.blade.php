                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        @foreach ($data as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset('foto/'.$row->foto_kepsek)}}" width="120px"
                                                         alt="{{$row->foto_kepsek}}">
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="btn btn-danger delete" data-id="{{$row->id}}"
                                                       data-nama="{{$row->nama_kepsek}}" id="delete">Delete</a>
                        ...
                        <form action="/insertdatakepsek" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="nama_kepsek"
                                           id="exampleInputEmail1" placeholder="Masukan Nama Kegiatan">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">Foto Kepala Sekolah</label>
                                    <input required type="file" class="form-control" name="foto_kepsek">
                                </div>
                                <div class="form-group">
