                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        @foreach ($data as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$row->isi}}</td>
                                                <td>
                                                    <img src="{{asset("logotentangweb/".$row->foto)}}" width="120px"
                                                         alt="">
                                                </td>


                                                <td>
                                                    <a href="/edittentangweb/{{$row->id}}"
                                                       class="btn btn-warning">Edit</a>
                                                    <a href="#" class="btn btn-danger delete" data-id="{{$row->id}}"
                                                       data-nama="{{$row->pembuka}}" id="delete">Delete</a>
                        ...
                        <form action="{{url("/insertdatatentangweb")}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="pembuka"
                                           id="exampleInputEmail1" placeholder="Masukan Pembuka">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Isi</label>
                                    <input required type="text" class="form-control" name="isi"
                                           id="exampleInputPassword1" placeholder="Masukan Isi">
                                </div>
                                <div class="form-group">
