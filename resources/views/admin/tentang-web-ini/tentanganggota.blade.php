                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        @foreach ($data as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset('fotoanggota/'.$row->foto)}}" width="120px"
                                                         alt="">
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="btn btn-danger delete" data-id="{{$row->id}}"
                                                       data-nama="{{$row->nama}}" id="delete">Delete</a>
                        ...
                        <form action="{{url("/insertdatatentanganggota")}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="nama" id="exampleInputEmail1"
                                           placeholder="Masukan Nama Anggota">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Keterangan</label>
                                    <input required type="text" class="form-control" name="keterangan"
                                           id="exampleInputPassword1" placeholder="Masukan Keterangan">
                                </div>
                                <div class="form-group">
