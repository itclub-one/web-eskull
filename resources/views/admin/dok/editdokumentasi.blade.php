                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$data->nama_kegiatan}}"
                                           name="nama_kegiatan" id="exampleInputEmail1"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$data->penyelenggara}}"
                                           name="penyelenggara" id="exampleInputPassword1"
                                           placeholder="Masukan Nama Penyelenggara">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">Foto Kegiatan</label>
                                    <input type="file" class="form-control" value="{{$data->foto_kegiatan}}"
                                           name="foto_kegiatan">
                                </div>
