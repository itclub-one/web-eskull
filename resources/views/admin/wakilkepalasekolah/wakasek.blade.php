                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        @foreach ($data as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset('foto/'.$row->foto_wakasek)}}" width="120px"
                                                         alt="{{$row->foto_wakasek}}">
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="btn btn-danger delete" data-id="{{$row->id}}"
                                                       data-nama="{{$row->nama_wakasek}}" id="delete">Delete</a>
                        ...
                        <form action="/insertdatawakasek" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="nama_wakasek"
                                           id="exampleInputEmail1" placeholder="Masukan Nama Wakil Kepala Sekolah">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="pembuka_sambutan"
                                           id="exampleInputPassword1" placeholder="Masukan Pembuka Sambutan">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Isi Sambutan</label>
                                    <input required type="text" class="form-control" name="isi_sambutan"
                                           id="exampleInputPassword1" placeholder="Masukan Isi Sambutan">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Penutup Sambutan</label>
                                    <input required type="text" class="form-control" name="penutup_sambutan"
                                           id="exampleInputPassword1" placeholder="Masukan Penutup Sambutan">
                                </div>
