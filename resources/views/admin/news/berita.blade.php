                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        @foreach ($data as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset('fotoberita/'.$row->foto_berita)}}" width="200px"
                                                         alt="">
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="btn btn-danger delete" data-id="{{$row->id}}"
                                                       data-nama="{{$row->judul_berita}}" id="delete">Delete</a>
                        ...
                        <form action="/insertdataberita" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="judul_berita"
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="date" class="form-control" name="tanggal_berita"
                                           id="exampleInputPassword1" placeholder="Masukan Tanggal Berita">
                                </div>
